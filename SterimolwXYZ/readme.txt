...
3.	Run the script with Gaussian input or output files and XYZ files
...
sterimol.py file(s)
```
* This program will read Gaussian input or output files or half-sandwich complexes or XYZ files.
